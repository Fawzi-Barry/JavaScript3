...
function calculateSum() {
  ...
  if (num1.value.length == 0 || num2.value.length == 0) {
    document.getElementById("t1-error").innerHTML =
      "PLEASE ENTER ALL INPUT FIELEDS";
    return;
  }
  document.getElementById("t1-error").innerHTML = "";
...
function guess() {
  ...
  if (num.value.length == 0) {
    document.getElementById("t2-error").innerHTML = "PLASE ENTER A NUMBER";
    return;
  }
...
function add() {
  ...
  if (num.value.length == 0) {
    document.getElementById("t5-error").innerHTML = "PLEASE ENTER A NUMBER";
    return;
  }
